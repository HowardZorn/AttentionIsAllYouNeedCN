...
\author{
  \AND
  Ashish Vaswani\thanks{都是一样的贡献。这里的顺序是随机排列的。Jakob提出了用自我关注取代RNN，并开始努力评估这个想法。
...
我们用来训练和评估我们的模型的代码可以在\url{https://github.com/tensorflow/tensor2tensor}上找到。

\paragraph{Acknowledgements} 我们感谢Nal Kalchbrenner和Stephan Gouws的
卓有成效的评论，更正和启发。
